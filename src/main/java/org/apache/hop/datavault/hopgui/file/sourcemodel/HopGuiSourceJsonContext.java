...
/** Context handler for clicks on a source JSON card. */
public class HopGuiSourceJsonContext extends BaseGuiContextHandler implements IGuiContextHandler {

  public static final String CONTEXT_ID = "HopGuiSourceJsonContext";

  private final SourceModel model;
  private final HopGuiSourceModelGraph sourceModelGraph;
  private final SourceJson jsonSource;
  private final Point click;

  public HopGuiSourceJsonContext(
      SourceModel model,
  ...
  public List<GuiAction> getSupportedActions() {
    ...
    GuiActionLambdaBuilder<HopGuiSourceJsonContext> lambdaBuilder = new GuiActionLambdaBuilder<>();
  ...
  public SourceJson getJsonSource() {
    return jsonSource;
  }
