...
public class HopGuiSourceModelSearchable implements ISearchable<SourceModel> {
  ...
  public HopGuiSourceModelSearchable(String location, SourceModel model) {
  ...
  public String getType() {
    return HopSourceModelFileType.SOURCE_MODEL_FILE_TYPE_DESCRIPTION;
  }
  ...
  public ISearchableCallback getSearchCallback() {
    return (searchable, searchResult) -> {
      IHopFileTypeHandler handler =
          ModelSearchOpenSupport.openModelFile(getFilename(), new HopSourceModelFileType());
