...
/** Calcite table backed by a {@link SourcePipeline} feed on a source model. */
@Getter
public class SourceModelPipelineTable extends AbstractTable implements TranslatableTable {

  private final SourcePipeline sourcePipeline;

  public SourceModelPipelineTable(SourcePipeline sourcePipeline) {
  ...
  public String logicalName() {
    return sourcePipeline.getName();
  }

  public DvSourceType physicalType() {
    return DvSourceType.PIPELINE;
  }
}
