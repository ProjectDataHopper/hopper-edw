...
public final class SourceJsonPipelineGenerator {
  ...
  private static PipelineMeta generateTableParent(
    ...
    org.hopper.edw.datavault.metadata.DvSourceType physicalType =
        table.getPhysicalType() != null
            ? table.getPhysicalType()
            : org.hopper.edw.datavault.metadata.DvSourceType.DATABASE;
    if (physicalType != org.hopper.edw.datavault.metadata.DvSourceType.DATABASE) {
