 ...
 */
package org.hopper.edw.datavault.metadata.lineage.xp;
...
/** Registers {@link LineageBackendMeta} with Hop metadata after environment init. */
@ExtensionPoint(
    id = "RegisterLineageBackendMetadataExtensionPoint",
    extensionPointId = "HopEnvironmentAfterInit",
    description = "Register Lineage Backend metadata")
public class RegisterLineageBackendMetadataExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    IPlugin thisPlugin =
        pluginRegistry.findPluginWithId(
            ExtensionPointPluginType.class, "RegisterLineageBackendMetadataExtensionPoint");
    ...
    pluginRegistry.registerPluginClass(
        ...
        libraries,
        pluginUrl,
        LineageBackendMeta.class.getName(),
        MetadataPluginType.class,
        HopMetadata.class,
        false);

    if (log != null) {
      log.logDetailed("Lineage Backend metadata registered");
    }
  }
}
