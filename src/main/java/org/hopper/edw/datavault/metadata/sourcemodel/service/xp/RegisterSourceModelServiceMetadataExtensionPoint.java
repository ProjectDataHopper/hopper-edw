 ...
 */
package org.hopper.edw.datavault.metadata.sourcemodel.service.xp;
...
/** Registers {@link SourceModelService} with Hop metadata after environment init. */
@ExtensionPoint(
    id = "RegisterSourceModelServiceMetadataExtensionPoint",
    extensionPointId = "HopEnvironmentAfterInit",
    description = "Register Source model service metadata")
public class RegisterSourceModelServiceMetadataExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    IPlugin thisPlugin =
        pluginRegistry.findPluginWithId(
            ExtensionPointPluginType.class, "RegisterSourceModelServiceMetadataExtensionPoint");
    ...
    pluginRegistry.registerPluginClass(
        ...
        libraries,
        pluginUrl,
        SourceModelService.class.getName(),
        MetadataPluginType.class,
        HopMetadata.class,
        false);

    if (log != null) {
      log.logDetailed("Source model service metadata registered");
    }
  }
}
