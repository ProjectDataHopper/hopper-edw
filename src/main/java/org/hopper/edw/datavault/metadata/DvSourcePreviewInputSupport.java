...
public final class DvSourcePreviewInputSupport {
  ...
  public static PreviewPipeline buildPreviewPipeline(
    ...
    return switch (sourceType) {
      ...
      case JSON ->
          buildJsonPreview(
              recordSource,
              (org.hopper.edw.datavault.metadata.json.DvJsonSource) dvSource,
              variables,
              metadataProvider,
              rowLimit);
      case PIPELINE ->
          buildPipelinePreview(
              recordSource,
              (org.hopper.edw.datavault.metadata.pipeline.DvPipelineSource) dvSource,
              variables,
              metadataProvider,
              rowLimit);
    };
  ...
  private static PreviewPipeline buildPipelinePreview(
      DataVaultSource recordSource,
      org.hopper.edw.datavault.metadata.pipeline.DvPipelineSource source,
      IVariables variables,
      IHopMetadataProvider metadataProvider,
      int rowLimit)
      throws HopException {
    ...
    org.apache.hop.pipeline.transforms.metainject.MetaInjectMeta metaInjectMeta =
        org.hopper.edw.datavault.metadata.pipeline.DvPipelineSourceSupport.buildMetaInjectMeta(
  ...
  private static PreviewPipeline buildJsonPreview(
      DataVaultSource recordSource,
      org.hopper.edw.datavault.metadata.json.DvJsonSource source,
      IVariables variables,
      IHopMetadataProvider metadataProvider,
      int rowLimit)
      throws HopException {
    ...
    org.hopper.edw.datavault.metadata.json.DvJsonSourceResolver.ResolvedJson resolved =
        org.hopper.edw.datavault.metadata.json.DvJsonSourceResolver.resolve(
            source, variables, metadataProvider);
    org.hopper.edw.datavault.metadata.sourcemodel.generate.SourceJsonPreviewSupport.PreviewPipeline
        built =
            org.hopper.edw.datavault.metadata.sourcemodel.generate.SourceJsonPreviewSupport
