...
public class DimensionalConfigurationEditor extends MetadataEditor<DimensionalConfiguration> {

  private static final Class<?> PKG = DimensionalConfiguration.class;
  private static final Class<?> DIALOG_PKG = HopGuiDimensionalModelDialog.class;
  ...
  public DimensionalConfigurationEditor(
      HopGui hopGui,
  ...
  public void createControl(Composite parent) {
    ...
    wlName.setText(BaseMessages.getString(PKG, "DimensionalConfigurationEditor.Name.Label"));
    ...
    wlDescription.setText(
        BaseMessages.getString(PKG, "DimensionalConfigurationEditor.Description.Label"));
    ...
    wGeneralTabComp =
        HopGuiDimensionalModelDialog.createTabComposite(
            tabFolder,
            BaseMessages.getString(DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.General.Label"),
            BaseMessages.getString(DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.General.ToolTip"));
    wTargetLoadTabComp =
        HopGuiDimensionalModelDialog.createTabComposite(
            tabFolder,
            BaseMessages.getString(DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.TargetLoad.Label"),
            BaseMessages.getString(
                DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.TargetLoad.ToolTip"));
    wGeneratedArtifactsTabComp =
        HopGuiDimensionalModelDialog.createTabComposite(
            tabFolder,
            BaseMessages.getString(
                DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.GeneratedArtifacts.Label"),
            BaseMessages.getString(
                DIALOG_PKG, "HopGuiDimensionalModelDialog.Tab.GeneratedArtifacts.ToolTip"));
  ...
  public void setWidgetsContent() {
    DimensionalConfiguration configuration = getMetadata();
  ...
  @Override
  public void getWidgetsContent(DimensionalConfiguration meta) {
    meta.setName(wName.getText());
    meta.setDescription(wDescription.getText());
    widgets.getWidgetsContents(meta, DimensionalConfiguration.GUI_PLUGIN_ELEMENT_PARENT_ID);
    widgets.getWidgetsContents(
        meta, DimensionalConfiguration.GUI_PLUGIN_ELEMENT_TARGET_LOAD_TAB_ID);
    widgets.getWidgetsContents(
        meta, DimensionalConfiguration.GUI_PLUGIN_ELEMENT_GENERATED_ARTIFACTS_TAB_ID);
  }
}
