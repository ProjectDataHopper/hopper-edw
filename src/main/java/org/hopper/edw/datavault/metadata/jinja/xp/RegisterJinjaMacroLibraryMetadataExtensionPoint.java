 ...
 */
package org.hopper.edw.datavault.metadata.jinja.xp;
...
/** Registers {@link JinjaMacroLibraryMeta} with Hop metadata after environment init. */
@ExtensionPoint(
    id = "RegisterJinjaMacroLibraryMetadataExtensionPoint",
    extensionPointId = "HopEnvironmentAfterInit",
    description = "Register Jinja Macro Library metadata")
public class RegisterJinjaMacroLibraryMetadataExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    IPlugin thisPlugin =
        pluginRegistry.findPluginWithId(
            ExtensionPointPluginType.class, "RegisterJinjaMacroLibraryMetadataExtensionPoint");
    ...
    pluginRegistry.registerPluginClass(
        ...
        libraries,
        pluginUrl,
        JinjaMacroLibraryMeta.class.getName(),
        MetadataPluginType.class,
        HopMetadata.class,
        false);

    if (log != null) {
      log.logDetailed("Jinja Macro Library metadata registered");
    }
  }
}
