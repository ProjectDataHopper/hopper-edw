...
import org.hopper.edw.datavault.metadata.database.DatabaseForeignKeyDiscoverySupport;
  ...
  static List<SourceRelationship> buildRelationshipsFromForeignKeys(
    ...
    for (DiscoveredForeignKey fk : foreignKeys) {
      ...
      relationship.setChildMultiplicity(
          org.hopper.edw.datavault.metadata.sourcemodel.SourceRelationshipMultiplicity
              .ZERO_OR_MANY);
      relationship.setParentMultiplicity(
          org.hopper.edw.datavault.metadata.sourcemodel.SourceRelationshipMultiplicity.ONE);
