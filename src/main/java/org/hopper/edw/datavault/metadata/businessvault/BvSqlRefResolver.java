...
import org.hopper.edw.datavault.jinja.BvSqlJinjaRenderResult;
import org.hopper.edw.datavault.jinja.BvSqlJinjaSupport;
...
public final class BvSqlRefResolver {
  ...
  private static boolean tryResolveFromCatalog(
    ...
    try {
      List<String> candidates =
          org.hopper.edw.datavault.catalog.CatalogModelRegistrySupport
  ...
  private static boolean trySiblingModelExtension(
    ...
    try {
      storedSibling =
          org.hopper.edw.datavault.metadata.DvModelLoadSupport.toStoredModelPath(
  ...
  public static String resolveSql(
    ...
    if (metadataProvider != null && dvModel != null) {
      try {
        dvDb =
            org.hopper.edw.datavault.metadata.DvSpecialRecordSupport.loadTargetDatabase(
