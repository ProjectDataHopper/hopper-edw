...
/** Registers {@link BusinessProcessCatalogMeta} with Hop metadata after environment init. */
@ExtensionPoint(
    id = "RegisterBusinessProcessCatalogMetadataExtensionPoint",
    extensionPointId = "HopEnvironmentAfterInit",
    description = "Register Business Process Catalog metadata")
public class RegisterBusinessProcessCatalogMetadataExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    IPlugin thisPlugin =
        pluginRegistry.findPluginWithId(
            ExtensionPointPluginType.class, "RegisterBusinessProcessCatalogMetadataExtensionPoint");
    ...
    pluginRegistry.registerPluginClass(
        ...
        libraries,
        pluginUrl,
        BusinessProcessCatalogMeta.class.getName(),
        MetadataPluginType.class,
        HopMetadata.class,
        false);

    if (log != null) {
      log.logDetailed("Business Process Catalog metadata registered");
    }
  }
}
