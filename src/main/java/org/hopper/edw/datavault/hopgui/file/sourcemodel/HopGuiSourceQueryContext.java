...
/** Context handler for clicks on a source query card. */
public class HopGuiSourceQueryContext extends BaseGuiContextHandler implements IGuiContextHandler {

  public static final String CONTEXT_ID = "HopGuiSourceQueryContext";
  ...
  public HopGuiSourceQueryContext(
      SourceModel model, HopGuiSourceModelGraph sourceModelGraph, SourceQuery query, Point click) {
    this.model = model;
  ...
  public List<GuiAction> getSupportedActions() {
    ...
    GuiActionLambdaBuilder<HopGuiSourceQueryContext> lambdaBuilder = new GuiActionLambdaBuilder<>();
