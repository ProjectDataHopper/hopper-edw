...
public class DvSatelliteDialog {
  ...
  private void addGeneralTab() {
    ...
    wOrphanPolicy.setItems(
        new String[] {
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.INHERIT.name(),
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.PASS.name(),
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.INFER.name(),
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.SENTINEL.name(),
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.QUARANTINE.name(),
          org.hopper.edw.datavault.metadata.DvOrphanPolicy.FAIL.name()
        });
  ...
  private void seedParentHub() {
    ...
    int added =
        org.hopper.edw.datavault.metadata.DvOrphanHandlingSupport.seedParentHubFromSatellite(
