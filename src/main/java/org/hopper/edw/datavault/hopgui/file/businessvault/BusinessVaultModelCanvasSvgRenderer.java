...
public final class BusinessVaultModelCanvasSvgRenderer {
  ...
  private BusinessVaultModelCanvasSvgRenderer() {}

  public static final class Context {
    public IVariables variables;
    public BusinessVaultModel model;
    public DataVaultModel dataVaultModel;
    ...
    public String mouseOverBvTableName;
    public String mouseOverDvReferenceName;
    public String mouseOverBvReferenceName;
    ...
    public IBvTable startRelationshipBvTable;
    public BvDvTableReference startRelationshipDvReference;
    public Point relationshipDragEndLocation;
    public IBvTable candidateRelationshipBvTable;
    public BvDvTableReference candidateRelationshipDvReference;
  }
  ...
  public static ModelGraphCanvasSvgResult render(Context ctx) throws HopException {
    if (ctx == null || ctx.model == null || ctx.canvasSize == null) {
      throw new HopException("Cannot render Business Vault model SVG: missing context or model.");
    }
    try {
      ...
      painter.setMouseOverBvTableName(ctx.mouseOverBvTableName);
      painter.setMouseOverDvReferenceName(ctx.mouseOverDvReferenceName);
      painter.setMouseOverBvReferenceName(ctx.mouseOverBvReferenceName);
      ...
      painter.setDataVaultModel(ctx.dataVaultModel);
      painter.setRelationshipDragInfo(
          ctx.startRelationshipBvTable,
          ctx.startRelationshipDvReference,
          ctx.relationshipDragEndLocation,
          ctx.candidateRelationshipBvTable,
          ctx.candidateRelationshipDvReference);

      painter.drawBusinessVaultModel(ctx.metadataProvider);
