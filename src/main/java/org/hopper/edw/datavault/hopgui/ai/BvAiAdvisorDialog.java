...
import org.hopper.edw.datavault.ai.DvAiAvailability;
...
import org.hopper.edw.datavault.ai.businessvault.BvAiAdvisorService;
import org.hopper.edw.datavault.ai.businessvault.BvAiContextBuilder;
import org.hopper.edw.datavault.ai.businessvault.BvAiConversationSession;
import org.hopper.edw.datavault.ai.businessvault.BvAiProposalApplier;
import org.hopper.edw.datavault.ai.businessvault.BvAiProposalValidator;
import org.hopper.edw.datavault.ai.businessvault.BvAiRequest;
import org.hopper.edw.datavault.ai.businessvault.BvAiScenario;
  ...
  private void reviewProposalsForTurn(int turnIndex) {
    ...
    ModelAiProposalReviewDialog reviewDialog =
        new ModelAiProposalReviewDialog(
            shell, proposals, mapValidationResults(validation), BvAiProposalApplier::preview);
