...
public final class SourceModelCanvasSvgRenderer {
  ...
  private SourceModelCanvasSvgRenderer() {}
  ...
  public static final class Context {
    ...
    public Object startRelationshipNode;
    public Point relationshipDragEndLocation;
    public Object candidateRelationshipTarget;
  }
  ...
  public static ModelGraphCanvasSvgResult render(Context ctx) throws HopException {
    if (ctx == null || ctx.model == null || ctx.canvasSize == null) {
      throw new HopException("Cannot render source model SVG: missing context or model.");
    }
    try {
      ...
      SourceModelPainter painter =
          new SourceModelPainter(ctx.model, gc, ctx.variables, ctx.canvasSize.x, ctx.canvasSize.y);
      ...
      painter.setRelationshipDragInfo(
          ctx.startRelationshipNode,
          ctx.relationshipDragEndLocation,
          ctx.candidateRelationshipTarget);

      painter.drawSourceModel(ctx.metadataProvider);
      ...
      throw new HopException(
          "Unable to generate SVG for source model "
