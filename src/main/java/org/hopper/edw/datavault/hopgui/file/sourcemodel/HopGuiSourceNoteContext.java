...
/** Context handler for clicks on a note in the source model graph. */
public class HopGuiSourceNoteContext extends BaseGuiContextHandler implements IGuiContextHandler {

  public static final String CONTEXT_ID = "HopGuiSourceNoteContext";
  ...
  public HopGuiSourceNoteContext(
      SourceModel model, HopGuiSourceModelGraph sourceModelGraph, DvNote note, Point click) {
    this.model = model;
  ...
  public List<GuiAction> getSupportedActions() {
    ...
    GuiActionLambdaBuilder<HopGuiSourceNoteContext> lambdaBuilder = new GuiActionLambdaBuilder<>();
