...
/** Context handler for clicks on a source relationship edge. */
public class HopGuiSourceRelationshipContext extends BaseGuiContextHandler
    implements IGuiContextHandler {

  public static final String CONTEXT_ID = "HopGuiSourceRelationshipContext";

  private final SourceModel model;
  private final HopGuiSourceModelGraph sourceModelGraph;
  private final SourceRelationship relationship;
  private final Point click;

  public HopGuiSourceRelationshipContext(
      SourceModel model,
  ...
  public List<GuiAction> getSupportedActions() {
    ...
    GuiActionLambdaBuilder<HopGuiSourceRelationshipContext> lambdaBuilder =
  ...
  public SourceRelationship getRelationship() {
    return relationship;
  }
