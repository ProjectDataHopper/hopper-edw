...
public class ActionHarvestSourceMetadataDialog extends ActionDialog {
  ...
  private final ActionHarvestSourceMetadata action;
  private boolean cancelled = true;
  private GuiCompositeWidgets widgets;
  private Composite wSettingsComp;

  public ActionHarvestSourceMetadataDialog(
      Shell parent,
      ActionHarvestSourceMetadata action,
      WorkflowMeta workflowMeta,
      IVariables variables) {
    super(parent, workflowMeta, variables);
    this.action = action;
    if (Utils.isEmpty(action.getName())) {
      action.setName(BaseMessages.getString(PKG, "ActionHarvestSourceMetadata.Name"));
    }
  }
  ...
  public IAction open() {
    ...
    widgets.createCompositeWidgets(
        ...
        null,
        wSettingsComp,
        ActionHarvestSourceMetadata.GUI_PLUGIN_ELEMENT_PARENT_ID,
        null);
