...
import org.hopper.edw.datavault.hopgui.file.businessvault.BusinessVaultModelSvgPainter;
import org.hopper.edw.datavault.metadata.businessvault.BusinessVaultModel;

@DiagramExporter(
    id = "business-vault-svg",
    name = "Business Vault SVG Exporter",
    description = "Exports a Business Vault model diagram to Scalable Vector Graphics (SVG)",
    format = "SVG",
    fileExtension = "svg",
    fileFilterNames = {"SVG Files (*.svg)"},
    supportedSubjectTypes = {BusinessVaultModel.class})
public class BusinessVaultSvgDiagramExporter extends EdwSvgDiagramExporter<BusinessVaultModel> {
  ...
  public DiagramExportResult export(
    ...
    String svgXml =
        BusinessVaultModelSvgPainter.generateBusinessVaultModelSvg(
