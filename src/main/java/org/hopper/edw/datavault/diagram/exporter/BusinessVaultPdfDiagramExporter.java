...
@DiagramExporter(
    id = "business-vault-pdf",
    name = "Business Vault PDF Exporter",
    description = "Exports a Business Vault model diagram to a vector PDF",
    format = "PDF",
    fileExtension = "pdf",
    fileFilterNames = {"PDF Files (*.pdf)"},
    supportedSubjectTypes = {BusinessVaultModel.class})
public class BusinessVaultPdfDiagramExporter extends EdwPdfDiagramExporter<BusinessVaultModel> {
