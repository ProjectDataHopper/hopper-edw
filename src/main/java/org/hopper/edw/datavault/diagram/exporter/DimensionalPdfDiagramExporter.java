...
@DiagramExporter(
    id = "dimensional-pdf",
    name = "Dimensional model PDF Exporter",
    description = "Exports a dimensional model diagram to a vector PDF",
    format = "PDF",
    fileExtension = "pdf",
    fileFilterNames = {"PDF Files (*.pdf)"},
    supportedSubjectTypes = {DimensionalModel.class})
public class DimensionalPdfDiagramExporter extends EdwPdfDiagramExporter<DimensionalModel> {
