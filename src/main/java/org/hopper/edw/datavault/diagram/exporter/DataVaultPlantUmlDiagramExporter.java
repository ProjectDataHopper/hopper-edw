...
@DiagramExporter(
    id = "data-vault-plantuml",
    name = "Data Vault PlantUML Exporter",
    description = "Exports a Data Vault model as a PlantUML hub/link/satellite diagram",
    format = "PLANTUML",
    fileExtension = "puml",
    fileFilterNames = {"PlantUML Files (*.puml)"},
    supportedSubjectTypes = {DataVaultModel.class})
public class DataVaultPlantUmlDiagramExporter extends EdwTextDiagramExporter<DataVaultModel> {
