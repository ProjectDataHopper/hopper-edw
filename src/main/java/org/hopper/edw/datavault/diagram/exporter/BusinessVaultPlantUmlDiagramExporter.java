...
@DiagramExporter(
    id = "business-vault-plantuml",
    name = "Business Vault PlantUML Exporter",
    description = "Exports a Business Vault model as a PlantUML diagram",
    format = "PLANTUML",
    fileExtension = "puml",
    fileFilterNames = {"PlantUML Files (*.puml)"},
    supportedSubjectTypes = {BusinessVaultModel.class})
public class BusinessVaultPlantUmlDiagramExporter
