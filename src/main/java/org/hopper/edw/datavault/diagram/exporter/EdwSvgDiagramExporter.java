...
/** Shared SVG write-out for EDW diagram exporters. */
abstract class EdwSvgDiagramExporter<T> extends BaseDiagramExporter<T> {

  protected SvgRenderOptions renderOptions(DiagramExportOptions options) {
    return EdwDiagramExportSupport.toSvgRenderOptions(options);
  }

  protected DiagramExportResult finish(
      String svgXml, DiagramExportOptions options, IExportContext context) throws HopException {
