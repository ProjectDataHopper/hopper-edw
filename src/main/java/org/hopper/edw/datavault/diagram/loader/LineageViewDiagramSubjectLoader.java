...
public class LineageViewDiagramSubjectLoader extends EdwExtensionSubjectLoader {

  public LineageViewDiagramSubjectLoader() {
    super("hlv");
  }
  ...
  public Object loadSubject(
      ...
      throws HopException {
    return LineageViewPersistence.load(filename, metadataProvider, variables);
  }
}
