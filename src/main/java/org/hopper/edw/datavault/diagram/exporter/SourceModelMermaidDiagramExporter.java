...
@DiagramExporter(
    id = "source-model-mermaid",
    name = "Source model Mermaid Exporter",
    description = "Exports a source model as a Mermaid erDiagram",
    format = "MERMAID",
    fileExtension = "mmd",
    fileFilterNames = {"Mermaid Diagrams (*.mmd)"},
    supportedSubjectTypes = {SourceModel.class})
public class SourceModelMermaidDiagramExporter extends EdwTextDiagramExporter<SourceModel> {
