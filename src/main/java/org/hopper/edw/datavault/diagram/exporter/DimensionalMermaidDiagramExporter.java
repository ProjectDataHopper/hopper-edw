...
@DiagramExporter(
    id = "dimensional-mermaid",
    name = "Dimensional model Mermaid Exporter",
    description = "Exports a dimensional model as a Mermaid erDiagram",
    format = "MERMAID",
    fileExtension = "mmd",
    fileFilterNames = {"Mermaid Diagrams (*.mmd)"},
    supportedSubjectTypes = {DimensionalModel.class})
public class DimensionalMermaidDiagramExporter extends EdwTextDiagramExporter<DimensionalModel> {
