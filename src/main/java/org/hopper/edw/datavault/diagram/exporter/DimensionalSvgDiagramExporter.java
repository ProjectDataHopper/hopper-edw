...
import org.hopper.edw.datavault.hopgui.file.dimensional.DimensionalModelSvgPainter;
import org.hopper.edw.datavault.metadata.dimensional.DimensionalModel;

@DiagramExporter(
    id = "dimensional-svg",
    name = "Dimensional model SVG Exporter",
    description = "Exports a dimensional model diagram to Scalable Vector Graphics (SVG)",
    format = "SVG",
    fileExtension = "svg",
    fileFilterNames = {"SVG Files (*.svg)"},
    supportedSubjectTypes = {DimensionalModel.class})
public class DimensionalSvgDiagramExporter extends EdwSvgDiagramExporter<DimensionalModel> {
  ...
  public DiagramExportResult export(
    ...
    String svgXml =
        DimensionalModelSvgPainter.generateDimensionalModelSvg(
