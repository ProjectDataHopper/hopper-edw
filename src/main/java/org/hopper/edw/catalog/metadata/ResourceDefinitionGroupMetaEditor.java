...
public class ResourceDefinitionGroupMetaEditor extends MetadataEditor<ResourceDefinitionGroupMeta> {
  ...
  private void browseLineage() {
    ...
    new org.hopper.edw.datavault.hopgui.lineage.ReverseLineageBrowserDialog(
  ...
  private void browseHarvestHistory() {
    ResourceDefinitionGroupMeta draft = new ResourceDefinitionGroupMeta();
    getWidgetsContent(draft);
    org.hopper.edw.catalog.hopgui.perspective.SchemaHarvestHistoryGuiSupport.openForGroup(
  ...
  private void applyHarvestToCatalog() {
    ResourceDefinitionGroupMeta draft = new ResourceDefinitionGroupMeta();
    getWidgetsContent(draft);
    org.hopper.edw.catalog.harvest.SchemaHarvestApplyGuiSupport.applyCatalogFksFromHarvest(
        HopGui.getInstance(), draft);
  }
  ...
  private void generateHsmFromHarvest() {
    ResourceDefinitionGroupMeta draft = new ResourceDefinitionGroupMeta();
    getWidgetsContent(draft);
    org.hopper.edw.catalog.harvest.SchemaHarvestApplyGuiSupport.generateHsmFromHarvest(
        HopGui.getInstance(), draft);
  }
  ...
  private void openEdwJourney() {
    ResourceDefinitionGroupMeta draft = new ResourceDefinitionGroupMeta();
    getWidgetsContent(draft);
    org.hopper.edw.datavault.hopgui.perspective.journey.EdwJourneyPerspective perspective =
        org.hopper.edw.datavault.hopgui.perspective.journey.EdwJourneyPerspective.getInstance();
    if (perspective == null) {
      return;
    }
