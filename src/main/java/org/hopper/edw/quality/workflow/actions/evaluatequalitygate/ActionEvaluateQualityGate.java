 ...
 */
package org.hopper.edw.quality.workflow.actions.evaluatequalitygate;
...
import org.hopper.edw.quality.alert.QualityAlertContext;
import org.hopper.edw.quality.alert.QualityAlertSupport;
...
import org.hopper.edw.quality.model.QualityEvaluationMode;
import org.hopper.edw.quality.model.QualityLifecycle;
import org.hopper.edw.quality.service.DataQualityMeasureService;
import org.hopper.edw.quality.service.DataQualityReportFormatter;
import org.hopper.edw.quality.workflow.actions.measuredataquality.ActionMeasureDataQuality;
  ...
  private List<RecordDefinition> resolveSubjects() throws HopException {
    ...
    if (!Utils.isEmpty(resourceDefinitionGroup)) {
      ...
      String defaultNamespace =
          org.hopper.edw.datavault.catalog.DvCatalogNamespaces.projectSourcesNamespace(
              getVariables());
      for (var entry : usageIndex.entrySet()) {
        ...
        RecordDefinition definition =
            org.hopper.edw.catalog.registry.RecordDefinitionRegistry.getInstance()
