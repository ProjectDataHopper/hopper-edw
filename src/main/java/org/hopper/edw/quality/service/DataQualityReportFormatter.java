...
public final class DataQualityReportFormatter {
  ...
  public static String format(DataQualityReport report) {
    ...
    sb.append("Findings: ")
        ...
        .append(" (blocking=")
        .append(report.countBySeverity(org.hopper.edw.quality.model.QualitySeverity.BLOCKING))
        .append(", warning=")
        .append(report.countBySeverity(org.hopper.edw.quality.model.QualitySeverity.WARNING))
        .append(", info=")
        .append(report.countBySeverity(org.hopper.edw.quality.model.QualitySeverity.INFO))
        .append(")\n");
