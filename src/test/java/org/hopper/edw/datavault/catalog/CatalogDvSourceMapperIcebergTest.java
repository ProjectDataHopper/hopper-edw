...
class CatalogDvSourceMapperIcebergTest {
  ...
  void mapsIcebergLocationBetweenCatalogAndDvSource() {
    ...
    PhysicalIcebergTableRef physicalIcebergTable =
        org.hopper.edw.datavault.metadata.iceberg.DvIcebergLocationSupport
    ...
    org.hopper.edw.datavault.metadata.iceberg.DvIcebergLocationSupport.applyPhysicalIcebergTable(
