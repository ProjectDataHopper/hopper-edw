...
class LineageViewSeedSupportTest {
  ...
  void modelTableRefreshWritesJobAndDatasetIds() {
    ...
    assertEquals(
        ...
        query.getJob().toNodeId(org.hopper.edw.datavault.lineageview.backend.LineageNodeKind.JOB));
    assertEquals(
        "dataset:retail-dataset:f_orders",
        query
            .getDataset()
            .toNodeId(org.hopper.edw.datavault.lineageview.backend.LineageNodeKind.DATASET));
  }
