...
The hop-datavault plugin stores **record definitions** in the Hop **Data Catalog**. Modelers work in the **Data Catalog** perspective; generated pipelines and transforms resolve definitions by namespace and name.
