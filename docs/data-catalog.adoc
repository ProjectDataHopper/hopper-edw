...
. In the **Data Catalog perspective**, expand **Versions** under a FILE catalog connection to browse tags and open frozen record definitions **read-only** (snapshots are never edited from the UI).
