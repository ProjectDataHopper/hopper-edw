...
|**Open source in catalog**
|Jump to the source record definition in the Data Catalog perspective

|**Open target table**
|Open the selected model usage (hub, satellite, BV, or DM table)

|**Remediation proposals...**
|Open proposals and apply a fix

|**Acknowledge...**
|Accept a warning with a required comment

|**Revoke acknowledgement**
|Clear a previous acknowledgement
