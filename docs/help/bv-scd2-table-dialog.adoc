...
- **SQL Expression copies** — optional 2 / 4 / 8 parallel copies of the SQL Expression transform after collapse (default 1). Rows are round-robin distributed. Use this for CPU-heavy calculations on wide rows.
