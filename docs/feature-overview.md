...
Apache Hop plugin for **model-driven Data Vault 2.0**, **Business Vault**, and **dimensional** loading. Version **0.9.0-SNAPSHOT** (latest release **0.8.0**) requires **Apache Hop 2.19.0** (or a **recent 2.19.0-SNAPSHOT** until GA — [hop-client snapshots](https://repository.apache.org/content/groups/snapshots/org/apache/hop/hop-client/2.19.0-SNAPSHOT/)) and **Java 21**.
...
| Data type mappings (pre-modeling sources) | Available | [data-type-mappings.adoc](data-type-mappings.adoc), issue [#113](https://github.com/mattcasters/hop-data-vault/issues/113) |
