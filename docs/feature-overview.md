...
Apache Hop plugin for **model-driven Data Vault 2.0**, **Business Vault**, and **dimensional** loading. Version **0.6.0-SNAPSHOT** (latest release **0.5.0**) targets **Apache Hop 2.18.1** and **Java 21**.
