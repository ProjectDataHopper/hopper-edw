...
Issue https://github.com/ProjectDataHopper/hopper-edw/issues/127[#127].
...
In Hop **Metadata** perspective, under **EDW**, create a **Target type mapping** (key `target-type-mapping`).
