...
Apache Hop plugin for **model-driven Data Vault 2.0**, **Business Vault**, and **dimensional** loading. Version **0.9.0** requires **Apache Hop 2.19.0** (or a **recent 2.19.0-SNAPSHOT** until GA — https://repository.apache.org/content/groups/snapshots/org/apache/hop/hop-client/2.19.0-SNAPSHOT/[hop-client snapshots]) and **Java 21**.
