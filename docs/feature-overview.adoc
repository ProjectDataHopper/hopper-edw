...
**Data Hopper EDW** is a set of Apache Hop plugins for an **Enterprise Data Warehouse**: catalog, source models, **model-driven Data Vault 2.0**, **Business Vault**, and **dimensional** loading. Version **0.10.0** requires **Apache Hop 2.19.0** and **Java 21**.
