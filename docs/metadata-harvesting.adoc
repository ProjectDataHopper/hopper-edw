...
[Issue #112](https://github.com/mattcasters/hop-data-vault/issues/112) motivates treating “what do the sources look like now?” as its own wave in an EDW update.
