...
* Use **Load defaults**, **Add relative fields**, and **Add fiscal fields** to manage the output field pack; **Preview data** generates sample rows with the same logic as the transform.
