...
Retail example: `lnk_package_line` on `retail-360.hdv` maps `asn-package-lines` into `hub_order`, `hub_product`, `hub_warehouse`, `hub_customer`, and `hub_package_line` via the same field names on the ASN package-line feed.
