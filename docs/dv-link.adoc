...
* **Hub aliases (role-playing)** — same physical hub more than once on the link: natural hub for one role, alias for each extra role (from vs to, primary vs secondary). See link:dv-cross-model-references.adoc[Table references and hub aliases].
