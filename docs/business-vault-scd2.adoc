...
|`1 copy` (default), or `2` / `4` / `8` parallel copies of the generated SQL Expression transform after collapse. Rows are round-robin distributed. Use 4 or 8 for CPU-heavy calculations on wide rows.
