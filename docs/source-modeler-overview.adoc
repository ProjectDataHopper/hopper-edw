...
The **source modeler** captures source-system structure (tables, primary keys, foreign keys, and multi-table **source queries**) so Data Vault designers can feed hubs, links, and satellites without hand-written SQL for every join.
